...
<div class="card-body">
    ...
    <form action="<?= site_url('admin/article/edit/' . $post_id) ?>" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
        ...
        if (isset($post_thumbnail)) { ?>
            <div class="mb-3">
                <img src="<?= base_url(LOKASI_UPLOAD . "/" . $post_thumbnail) ?>" class="pb-2 mb-2 img-thumbnail w-50" alt="gambar">
            </div>
