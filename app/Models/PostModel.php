...
class PostModel extends CodeIgniterModel
{
    ...
    function insertPost($data, $post_type)
    {
        ...
        if (isset($data['post_id'])) {
            ...
            /**
             * syarat title_seo adalah angka dan huruf
             * 
             * title = Hello World
             * title_seo = hello-world
             * 
             * title2 = Helo World
             * title_seo = hello-world-2
             */
    ...
    function listPost($post_type, $jumlahBaris, $katakunci = null, $group_dataset = null)
    {
        ...
        // kata kunci = Hello world  -> maka perlu diambil per kata
    ...
    function updatePost($data, $post_type)
    {
        helper('global_fungsi_helper');
    ...
    function getDataBySeo($seo_title)
    {
        $builder = $this->table($this->table);
        $builder->where('post_title_seo', $seo_title);
        $query = $builder->get();
        return $query->getRowArray();
    }
}
